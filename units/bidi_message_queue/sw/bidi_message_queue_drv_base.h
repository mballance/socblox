...
class bidi_message_queue_drv_base {
	...
	protected:
		static const uint32_t				INBOUND_RD_PTR  = 0;
		static const uint32_t				INBOUND_WR_PTR  = 1;
		static const uint32_t				OUTBOUND_RD_PTR = 2;
		static const uint32_t				OUTBOUND_WR_PTR = 3;
