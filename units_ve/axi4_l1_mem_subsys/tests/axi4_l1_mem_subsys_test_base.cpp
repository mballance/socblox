/*
 * axi4_l1_mem_subsys_test_base.cpp
 *
...
axi4_l1_mem_subsys_test_base::axi4_l1_mem_subsys_test_base(const char *name) : svf_test(name) {
	// TODO Auto-generated constructor stub

}

axi4_l1_mem_subsys_test_base::~axi4_l1_mem_subsys_test_base() {
	// TODO Auto-generated destructor stub
}

void axi4_l1_mem_subsys_test_base::build()
{
	m_env = axi4_l1_mem_subsys_env::type_id.create("m_env", this);
}

void axi4_l1_mem_subsys_test_base::connect()
{
...
{
	m_runthread.init(this, &axi4_l1_mem_subsys_test_base::run);
	m_runthread.start();
}

void axi4_l1_mem_subsys_test_base::run()
{
...
void axi4_l1_mem_subsys_test_base::shutdown()
{

}

svf_test_ctor_def(axi4_l1_mem_subsys_test_base)
