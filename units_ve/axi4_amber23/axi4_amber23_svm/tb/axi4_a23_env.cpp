...
axi4_a23_env::axi4_a23_env(const char *name, svm_component *parent) :
...
{
	m_s0_bfm = axi4_svm_sram_bfm::type_id.create("m_s0_bfm", this);
...
svm_component_ctor_def(axi4_a23_env)
