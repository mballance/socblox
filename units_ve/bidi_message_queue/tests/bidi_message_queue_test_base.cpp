/*
 * bidi_message_queue_test_base.cpp
 *
...
bidi_message_queue_test_base::bidi_message_queue_test_base(const char *name) : svf_test(name) {
	// TODO Auto-generated constructor stub

}

bidi_message_queue_test_base::~bidi_message_queue_test_base() {
...
void bidi_message_queue_test_base::connect()
{
	...
	bidi_message_queue_bfm_dpi_mgr::connect(TB_ROOT + ".u_queue_bfm",
			m_env->m_message_queue_bfm->bfm_port);
}

void bidi_message_queue_test_base::start()
{
	m_runthread.init(this, &bidi_message_queue_test_base::run);
	m_runthread.start();
}

void bidi_message_queue_test_base::run()
{
	string target_exe;
...
void bidi_message_queue_test_base::shutdown()
{

}

svf_test_ctor_def(bidi_message_queue_test_base)
