...
#ifndef SVM_DPI_CLOSURE_H_
#define SVM_DPI_CLOSURE_H_
#include <string>
 ...
 *
 */
#define SVM_DPI_CLOSURE_IMPORT_TASK(prefix, method, prototype, args) \
...
#define SVM_DPI_CLOSURE_EXPORT_TASK(prefix, method, prototype, args) \
...
#define SVM_DPI_CLOSURE_REGISTER_TASK(prefix) \
...
template <class host_if_t, class target_if_t> class svm_dpi_closure : public virtual target_if_t {

	public:
		typedef svm_bidi_api_port<host_if_t, target_if_t>	port_t;

		svm_dpi_closure(const string &target) : m_target(target), m_port(0) { }
