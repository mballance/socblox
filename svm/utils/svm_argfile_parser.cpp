...
svm_argfile_parser::svm_argfile_parser() : m_unget_ch(-1) {
	// TODO Auto-generated constructor stub

}

int svm_argfile_parser::process(int argc, const char * const* argv)
{
...
const vector<string> &svm_argfile_parser::cmdline() const
{
	return m_args;
}
...
string svm_argfile_parser::expand(const string &path)
{
	string ret;
...
bool svm_argfile_parser::next_tok(string &tok)
{
	bool ret = false;
	int ch;
	tok.clear();
...
void svm_argfile_parser::unget_ch(int ch)
{
	m_unget_ch = ch;
}
