...
LIBSVF_A23=$(SOCBLOX_A23_LIBDIR)/libsvf.a

#LIBSVF_SC_QS_LINK=-L$(SOCBLOX_LIBDIR) -lsvf -lsvf_sc_qs
#LIBSVF_HOST_LINK=-L$(SOCBLOX_LIBDIR) -lsvf -lsvf_host

LIB_TARGETS += $(LIBSVF) $(LIBSVF_SC) $(LIBSVF_SC_QS) $(LIBSVF_DPI) $(LIBSVF_DPI_DPI) 
LIB_TARGETS += $(LIBSVF_HOST) $(LIBSVF_A23)
...
SVF_A23_OBJS=$(foreach o,$(SVF_SRC:.cpp=.o),$(SOCBLOX_A23_OBJDIR)/$(o))
